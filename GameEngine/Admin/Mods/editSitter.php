...
$sit1Name = 'none';
if ($sit1 > 0) {
    $sit1Name = $database->getUserField($sit1, 'username', 0) ?: 'UID ' . $sit1;
}

$sit2Name = 'none';
if ($sit2 > 0) {
    $sit2Name = $database->getUserField($sit2, 'username', 0) ?: 'UID ' . $sit2;
}

$sit1NameSafe = htmlspecialchars((string)$sit1Name, ENT_QUOTES, 'UTF-8');
$sit2NameSafe = htmlspecialchars((string)$sit2Name, ENT_QUOTES, 'UTF-8');

$logText =
    "Changed sitters for user " .
    "<a href='admin.php?p=player&uid=$id'>$targetNameSafe</a> " .
    "(sit1=$sit1NameSafe, sit2=$sit2NameSafe)";
