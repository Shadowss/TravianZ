...
// Faza 2 (09.09.2026): editare/stergere mesaj, sondaje, emoji
tz_def('GCHAT_EDIT',          'Editeaza');
tz_def('GCHAT_SAVE',          'Salveaza');
tz_def('GCHAT_CANCEL',        'Anuleaza');
tz_def('GCHAT_EDITED_TAG',    '(editat)');
tz_def('GCHAT_DELETE',        'Sterge');
tz_def('GCHAT_CONFIRM_DELETE', 'Stergi acest mesaj?');
tz_def('GCHAT_DELETED_PLACEHOLDER', 'Mesaj sters de un moderator.');
tz_def('GCHAT_POLL_TITLE',    'Creeaza un sondaj');
tz_def('GCHAT_POLL_QUESTION_PLACEHOLDER', 'Intrebare...');
tz_def('GCHAT_POLL_OPTION_PLACEHOLDER', 'Optiune');
tz_def('GCHAT_POLL_ADD_OPTION', '+ Optiune');
tz_def('GCHAT_POLL_CREATE',   'Creeaza sondaj');
