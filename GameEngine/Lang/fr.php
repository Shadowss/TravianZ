...
define('TRIBE6', 'Huns');
define('TRIBE7', 'Egyptiens');
define('TRIBE8', 'Spartiates');
...
define('EMAIL_ERROR', 'L\'adresse e-mail ne correspond pas à un e-mail existant');
...
define('SIT_ERROR', 'Co-gestionnaire déjà défini ou joueur introuvable');
...
define('ATAG_EXIST', 'Ce tag existe déjà');
define('ANAME_EXIST', 'Ce nom existe déjà');
...
define('USER_NOT_IN_YOUR_ALLY', "Ce joueur n'est pas dans votre alliance!");
...
define('OFFERED_CONFED_TO', 'a proposé un pacte total à');
...
define('NAME_NO_EXIST', 'Il n\'y a pas de joueur avec ce nom');
define('ID_NO_EXIST', 'Il n\'y a pas de joueur avec cet id ');
...
define('GO2MY_VILLAGE', 'Vers mon village');
define('VILLAGE_CENTER', 'Centre ville');
define('FINISH_GOLD', 'Terminer immédiatement toutes les constructions et les recherches dans ce village pour 2 Or ?');
define('WAITING_LOOP', '(file d\'attente)');
define('CROP_NEGATIVE', 'Votre production de céréales est négative, vous n\'atteindrez jamais la quantité de ressources demandée.');
define('HR', 'h.');
define('HRS', '(h.)');
...
define('P_IN', 'dans');
define('MS', 'ms');
define('SEVER_TIME', 'Heure Serveur :');
...
define('LINKS', 'Liens');
define('CANCEL_PROCESS', 'Annuler la tâche');
define('ACCOUNT_DELETING', 'Le compte sera supprimé dans');
define('INBOX', 'Réception');
define('WRITE', 'Ecrire');
define('SENT', 'Envoyé');
define('SEND', 'Envoyer');
...
define('ONLINE_S1', 'En ligne');
define('ONLINE_S2', 'Hors ligne');
define('ONLINE_S3', 'Hors ligne depuis 3 jours');
define('ONLINE_S4', 'Hors ligne depuis 7 jours');
...
define('NATAR_COUNTERFORCE', 'Contre-offensive Natar');
...
define('U2', 'Prétorien');
define('U3', 'Impérian');
define('U4', 'Equitès Légati');
define('U5', 'Equitès Impératoris');
define('U6', 'Equitès Caesaris');
define('U7', 'Bélier');
...
define('U46', 'Chevalier Natar');
define('U47', 'Éléphant de Guerre');
define('U48', 'Baliste');
define('U49', 'Empereur Natar');
define('U50', 'Colon Natar');
//HUNS (TRIBE 6)
define('U51', 'Mercenaire');
define('U52', 'Archer');
define('U53', 'Guetteur');
define('U54', 'Cavalier des Steppes');
define('U55', 'Archer Monté');
define('U56', 'Maraudeur');
define('U57', 'Bélier');
define('U58', 'Catapulte');
define('U59', 'Logades');
define('U60', 'Colon');
//EGYPTIANS (TRIBE 7)
define('U61', 'Milicien Esclave');
define('U62', 'Sentinelle');
define('U63', 'Soldat au Khopesh');
define('U64', 'Explorateur de Sopdou');
define('U65', "Garde d'Anhour");
define('U66', 'Char de Reshep');
define('U67', 'Bélier');
define('U68', 'Catapulte de pierre');
define('U69', 'Nomarque');
define('U70', 'Colon');
//SPARTANS (TRIBE 8)
define('U71', 'Hoplite Spartiate');
define('U72', 'Guerrier de l\'Agogé');
define('U73', 'Homoioi');
define('U74', 'Éclaireur Périèque');
define('U75', 'Cavalier Spartiate');
define('U76', 'Cavalier Elpida');
define('U77', 'Bélier');
define('U78', 'Catapulte');
define('U79', 'Éphore');
define('U80', 'Colon');
//VIKINGS (TRIBE 9)
define('U81', 'Thrall');
define('U82', 'Œil de Heimdall');
define('U83', 'Guerrière au Bouclier');
define('U84', 'Berserker');
define('U86', 'Cavalier Huscarl');
define('U85', 'Bénédiction de la Valkyrie');
define('U87', 'Bélier');
define('U88', 'Catapulte');
define('U89', 'Jarl');
define('U90', 'Colon');
...
define('BECOME_COMUNITY2', 'Devenez une partie de l\'un des plus grands jeux <br> communautaire au monde.');
define('NEWS','Actualités');
define('SCREENSHOTS','Captures d\'écran');
define('AGB', 'Conditions générales');
define('LEARN1', 'Améliorez vos champs et mines afin d\'augmenter votre production de ressources. Vous aurez besoin de ressources pour construire des bâtiments et entraîner des soldats.');
...
define('CHOOSE', 'Choisissez un serveur.');
...
define('BEFORE_REGISTER', 'Avant de créer un compte, vous devez lire les <a href="../anleitung.php" target="_blank">instructions</a> de Travian RO1 pour voir les avantages spécifiques et les inconvénients des différentes tribus.');
...
define('ARRIVING_REINF_TROOPS', 'Arrivée des renforts');
define('ARRIVING_ATTACKING_TROOPS', "Arrivée de l'attaque");
...
define('FOUNDNEWVILLAGE', 'Fonder un nouveau village');
define('UNDERATTACK', 'Le village est attaqué');
define('OASISATTACK', 'L\'Oasis est attaqué');
define('OASISATTACKS', 'Att. Oasis');
define('RETURNFROM', 'Retour de');
define('REINFORCEMENTFOR', 'Renforts vers');
...
define('CATAPULT_TARGET', 'Cible(s) des Catapultes');
define('INCOMING_TROOPS', 'Retour des Troupes');
...
define('TROOPS_IN_OTHER_VILLAGE', 'Troupes dans d\'autres villages');
define('TROOPS_IN_OASIS', 'Troupes dans les oasis');
define('KILL', 'Tuer');
define('FROM', 'De');
...
define('UNOCCUOASIS', 'Oasis inoccupé');
define('OCCUOASIS', 'Oasis occupé');
...
define('BUILDRALLY', 'Construire une place de rassemblement');
...
define('CROPFINDER', 'Chercher 9C/15C');
define('NORTH', 'Nord');
define('EAST', 'Est');
define('SOUTH', 'Sud');
define('WEST', 'Ouest');
...
//LOGIN.php
define('COOKIES', 'Vous devez avoir activé les cookies pour pouvoir vous connecter. Si vous partagez cet ordinateur avec d\'autres personnes, vous devez vous déconnecter après chaque session pour votre propre sécurité.');
define('NAME', 'Nom');
...
define('MASS_REALLY', 'Voulez-vous vraiment envoyer un message de masse ?');
define('MASS_ABORT', 'Abandonner maintenant');
define('MASS_SENT', 'Le message de masse a été envoyé');
...
define('WAREHOUSE', 'Dépôt de ressources');
...
define('WAREHOUSE_DESC', 'Les ressources bois, argile et fer sont stockées dans votre dépôt. En augmentant son niveau, vous augmentez la capacité de votre dépôt. Peut être construit plusieurs fois, une fois le premier au niveau maximum.');

define('GRANARY', 'Silo de céréales');
define('CROP_UNITS', 'Unités de céréales');
define('GRANARY_DESC', 'Les céréales produites par vos fermes sont stockées dans le silo de céréales. En augmentant son niveau, vous augmentez la capacité du silo. Peut être construit plusieurs fois, une fois le premier au niveau maximum.');

define('BLACKSMITH', 'Forgeron');
...
define('EXPAND_WAREHOUSE', 'Agrandissez<br>le d&eacute;p&ocirc;t');
define('EXPAND_GRANARY', 'Agrandissez<br>le grenier');
...
define('TOO_FEW_RESOURCES', 'Pas assez de<br>ressources');
...
define('CURRENT_SPEED', 'Bonus vitesse actuel :');
define('SPEED_LEVEL', 'Bonus vitesse au niveau');
...
define('RALLYPOINT', 'Place de Rassemblement');
...
define('RALLYPOINT_DESC', 'Les troupes de votre village se rassemblent ici. De là, vous pouvez les envoyer conquérir, piller ou renforcer d\'autres villages.<br>S\'il y a moins d\'unités attaquantes que le niveau de la place de rassemblement, vous pouvez voir le type d\'unité qui attaque.');
...
define('OR_', 'ou');
define('GO', 'Lancer');
define('UNITS_OF_RESOURCE', 'ressources');
define('MERCHANT_CARRY', 'Chaque marchand peut transporter');
define('MERCHANT_COMING', 'Marchands arrivant');
...
define('BANNED_CANNOT_SEND_RESOURCES', 'Joueur banni. Vous ne pouvez pas lui envoyer de ressources');
...
define('TOO_FEW_MERCHANTS', 'Pas assez de marchands');
define('OWN_MERCHANTS_ONWAY', 'Vos marchands en chemin');
define('MERCHANTS_RETURNING', 'Retour de marchands');
define('TRANSPORT_TO', 'Transport vers');
define('I_AN_SEARCHING', 'Je recherche');
define('I_AN_OFFERING', 'J\'offre');
define('OFFERS_MARKETPLACE', 'Offres sur la place du marché');
define('NO_AVAILABLE_OFFERS', 'Aucune offre sur la place du marché');
...
define('SEARCHING', 'Reherche');
define('OFFERING', 'Offre');
define('MAX_TIME_TRANSPORT', 'Durée de transport max.');
define('OWN_ALLIANCE_ONLY', 'Mon alliance uniquement');
...
define('VAC_COND3', 'Aucune troupe envoyée en renfort vers d\'autres villages');
define('VAC_COND4', 'Aucun joueur n\'a de renforts dans vos villages');
define('VAC_COND5', 'Ne pas posséder de Merveille du Monde');
define('VAC_COND6', 'Ne posséder aucun artefact'); 
define('VAC_COND7', 'Vous n\'êtes plus sous protection des débutants');
define('VAC_COND8', 'Vous n\'avez aucune troupe dans vos pièges');
define('VAC_COND9', 'Votre compte n\'est pas en cours de suppression');
define('NOT_ENOUGH_RESOURCES', 'Pas assez de ressources');
define('OFFER', 'Offre');
define('SEARCH', 'Reherche');
define('OWN_OFFERS', 'Mes offres');
define('ALL', 'Tout');
define('NPC_TRADE', 'Commerce NPC');
define('SUM', 'Somme');
define('REST', 'Reste');
...
define('YOU_CAN_NAT_NPC_WW', 'Vous ne pouvez pas utiliser le commerce NPC dans le village merveille');
define('NPC_TRADING', 'Commerce NPC');
define('SEND_RESOURCES', 'Envoyer les Resources');
define('BUY', 'Acheter');
...
define('EDIT', 'Éditer');
define('EXTEND_TRADE_ROUTES', 'Prolonger la route commerciale de <b>7</b> jours pour');
...
define('EDIT_TRADE_ROUTES', 'Editer route commerciale');
...
define('BARRACKS_DESC', 'L\'infanterie peut être entraînée à la caserne. Plus son niveau est élevé, plus les troupes sont entraînées rapidement.');

define('STABLE', 'Écurie');
define('AVAILABLE_ACADEMY', 'Aucune unité disponible. Recherche à l\'académie requise');
define('TRAINING_COMMENCE_STABLE', 'L\'entraînement pourra commencer une fois l\'écurie terminée.');
define('STABLE_DESC', 'La cavalerie peut être entraînée à l\'écurie. Plus son niveau est élevé, plus les troupes sont entraînées rapidement.');

define('WORKSHOP', 'Atelier');
define('TRAINING_COMMENCE_WORKSHOP', 'L\'entraînement pourra commencer une fois l\'atelier terminé.');
define('WORKSHOP_DESC', 'Les machines de siège, comme les catapultes et les béliers, peuvent être fabriquées à l\'atelier. Plus son niveau est élevé, plus les unités sont produites rapidement.');
...
define('EXPAND_WAREHOUSE1', 'Développer le dépôt');
define('EXPAND_GRANARY1', 'Développer le grenier');
...
define('ACADEMY_DESC', 'De nouveaux types d\'unités peuvent être recherchés à l\'académie. En augmentant son niveau, vous pouvez ordonner la recherche de meilleures unités.');

define('CRANNY', 'Cachette');
define('CURRENT_HIDDEN_UNITS', 'Ressources cachés actuelles (par ressource) :');
define('HIDDEN_UNITS_LEVEL', 'Ressources cachés au niveau');
define('UNITS', 'unités');
...
define('CELEBRATIONS_COMMENCE_TOWNHALL', 'Les fêtes pourront commencer une fois l\'hôtel de ville terminé.');
define('GREAT_CELEBRATIONS', 'Grande fête');
define('CULTURE_POINTS', 'Points de Culture');
define('HOLD', 'Organiser');
define('CELEBRATIONS_IN_PROGRESS', 'Fête</br>en cours');
define('CELEBRATIONS', 'Fête');
...
define('CAPITAL', 'C\'est votre Capitale');
define('RESIDENCE_TRAIN_DESC', 'Pour fonder un nouveau village, il faut une résidence de niveau 10 ou 20 et 3 colons. Pour conquérir un nouveau village, il faut une résidence de niveau 10 ou 20 et un sénateur, un chef, ou un chef de tribu.');
...
define('NONE_CONQUERED_BY_VILLAGE', 'Aucun village n\'a encore été fondé ou conquis par ce village.');
define('RESIDENCE_CULTURE_DESC','Pour étendre votre empire, vous avez besoin de points de culture. Ces points de culture augmentent au fil du temps et le font plus rapidement lorsque les niveaux de votre bâtiment augmentent.');
define('RESIDENCE_LOYALTY_DESC', 'En attaquant avec des sénateurs, des chefs ou des chefs de tribu, la loyauté d\'un village peut être réduite. S\'il atteint zéro, le village rejoint le royaume de l\'attaquant. La loyauté de ce village est actuellement à ');
define('RESIDENCE_DESC', 'La résidence est un petit palais, où le roi ou la reine vit quand il visite le village. La résidence protège le village contre les ennemis qui veulent le conquérir. Vous pouvez construire une résidence par village. Les unités capables de fonder un nouveau village ou de conquérir des villages existants peuvent y être entraînées.<br>De plus, la résidence offre un emplacement d\'expansion aux niveaux 10 et 20.');
...
define('TREASURY', 'Chambre du Trésor');
define('TREASURY_COMMENCE', 'Les artefacts peuvent être consultés une fois la chambre du trésor terminée.');
define('ARTEFACTS_AREA', 'Artefacts dans votre zone');
define('NO_ARTEFACTS_AREA', 'Il n\'y a aucun artefact dans votre zone.');
define('OWN_ARTEFACTS', 'Mes Artéfacts');
define('CONQUERED', 'Conquis');
define('DISTANCE', 'Distance');
define('EFFECT', 'Effet');
define('ACCOUNT', 'Compte');
define('SMALL_ARTEFACTS', 'Petits Artéfacts');
define('LARGE_ARTEFACTS', 'Grands Artéfacts');
define('NO_ARTEFACTS', 'Il n\'y a pas d\'Artéfacts');
define('ANY_ARTEFACTS', 'Vous ne possédez aucun Artéfact.');
...
define('TREASURY_DESC', 'Les richesses de votre empire sont conservées dans la Chambre du Trésor. La Chambre du Trésor ne peut contenir qu\'un seul artefact à la fois.<br>Vous avez besoin d\'une Chambre au Trésor de niveau 10 pour un petit artefact, ou de niveau 20 pour un grand. Après avoir capturé un Artéfact, il faut 24 heures sur un serveur normal ou 12 heures sur un serveur trois fois plus rapide pour être efficace.');

define('TRADEOFFICE', 'Comptoir de Commerce');
define('CURRENT_MERCHANT', 'Les marchands transportent actuellement :');
define('MERCHANT_LEVEL', 'Les marchands transporteront au niveau');
define('TRADEOFFICE_DESC', 'Dans le Comptoir de Commerce, les charrettes des marchands sont améliorées et équipées de puissants chevaux. Plus son niveau est élevé, plus vos marchands sont capables de transporter.');
...
define('STONEMASON', 'Atelier du Tailleur de Pierre');
define('CURRENT_STABILITY', 'Bonus de résistance actuel :');
define('STABILITY_LEVEL', 'Bonus de résistance au niveau');
define('STONEMASON_DESC', 'Le tailleur de pierre est un expert en taille de pierre. Plus le bâtiment est développé, plus la stabilité des bâtiments du village est élevée. À chaque niveau, ce bâtiment augmente la durabilité de 10 % jusqu\'à un maximum de 200 % de durabilité pour vos bâtiments.<br>Ce bâtiment ne peut être construit que dans la capitale d\'un empire.');

define('BREWERY', 'Brasserie');
define('CURRENT_BONUS', 'Bonus actuel :');
define('WATERWORKS_HINT', '(Amélioré par le Réservoir d\'eau)');
define('WATERWORKS_AFFECTED', 'Les oasis annexées bénéficient de ce bonus.');
define('OASIS_EFFECTIVE_BONUS', 'Bonus d\'oasis effectif :');
...
define('TRAPPER', 'Fabricant de Pièges');
define('CURRENT_TRAPS', 'Nombre maximum de pièges actuellement :');
define('TRAPS_LEVEL', 'Nombre maximum de pièges au niveau');
define('TRAPS', 'Pièges');
define('TRAP', 'Piège');
define('CURRENT_HAVE', 'Vous avez actuellement');
define('WHICH_OCCUPIED', 'occupés.');
define('TRAINING_COMMENCE_TRAPPER', 'Poser des pièges n\'est possible que lorsque le Fabricant de pièges est terminé.');
define('TRAPPER_DESC', 'Le fabricant de pièges protège votre village avec des pièges bien cachés. Cela signifie que des ennemis imprudents peuvent être emprisonnés et ne pourront plus nuire à votre village.<br>Les troupes ne peuvent pas être libérées par un pillage. Si le propriétaire des pièges libère les captifs, tous les pièges seront réparés automatiquement.<br>Spécifique à la tribu : Gaulois uniquement.');
...
define('NOT', 'Non ');
define('TRAIN_HERO', 'Entrainer un nouveau Héros');
define('REVIVE', 'Réssusciter');
define('OASES', 'Oasis');
...
define('HEROSMANSION_DESC', 'Dans le manoir du héros, vous pouvez former votre propre héros et aux niveaux 10, 15 et 20, vous pouvez conquérir des oasis avec ce Héros dans les environs immédiats. Selon l\'oasis, vous obtiendrez une augmentation de production d\'un certain type de ressource (voire deux ressources pour certaines oasis).');

define('GREATWAREHOUSE', 'Grand Dépôt');
define('GREATWAREHOUSE_DESC', 'Le grand dépôt a 3 fois la capacité d\'un dépôt normal.<br>Ce bâtiment ne peut être construit que dans les villages de Merveille du monde ou avec un artefact natarien spécial.');
...
define('WORLD_WONDER_CHANGE_NAME', 'Vous devez avoir une Merveille niveau 1 pour pouvoir changer de nom.');
define('WORLD_WONDER_NAME', 'Nom de la Merveille');
define('WORLD_WONDER_NOTCHANGE_NAME', 'Vous ne pouvez pas changer le nom de la Merveille après le niveau 10');
define('WORLD_WONDER_NAME_CHANGED', 'Nom changé');
...
define('STONEWALL', 'Mur de Pierre');
define('STONEWALL_DESC', 'Le mur de pierre protège votre village contre les attaques d\'autres joueurs. Sa construction solide confère un bonus de défense élevé.<br>Spécifique à la tribu : Égyptiens uniquement');
define('MAKESHIFTWALL', 'Mur de Fortune');
define('MAKESHIFTWALL_DESC', 'Le mur de fortune offre une protection de base pour votre village. Il est peu coûteux et rapide à construire, mais n\'offre qu\'un faible bonus de défense.<br>Spécifique à la tribu : Huns uniquement');
define('COMMANDCENTER', 'Centre de Commandement');
...
define('HOSPITAL_DESC', 'L\'hôpital soigne vos troupes blessées. Une partie des unités perdues lors de la défense ou de l\'attaque peut y être soignée au lieu d\'être perdue à jamais. Les niveaux supérieurs réduisent le temps de guérison.');
define('DEFENSIVEWALL', 'Mur Défensif');
define('DEFENSIVEWALL_DESC', 'Le mur défensif protège votre village contre les attaques d\'autres joueurs. Construit dans la tradition des grandes fortifications spartiates, il confère un bonus de défense important.<br>Spécifique à la tribu : Spartiates uniquement');
define('BIGHOSPITAL', 'Grand hôpital');
define('BIGHOSPITAL_DESC', 'Le Grand hôpital est une version améliorée de l\'hôpital ; il permet de soigner un plus grand nombre de vos troupes blessées après la bataille. Les niveaux supérieurs réduisent le temps de soin.<br>Spécifique à la tribu : Spartiates et Vikings uniquement');
define('BARRICADE', 'Barricade');
define('HEALING_TIME_NOW', 'Temps de soin actuel');
define('WOUNDED_TROOPS', 'Troupes blessées');
define('NO_WOUNDED', 'Aucune troupe blessée à l\'hôpital.');
define('HEAL_BUTTON', 'Soigner');
define('HEAL_COST_HINT', 'Le soin coûte 50 % du coût d\'entraînement de l\'unité.');
define('HEALING_IN_PROGRESS', 'Soin en cours');
define('MANUAL_UDESC_51', 'Le Guerrier hun constitue l\'épine dorsale de l\'infanterie hunnique. Peu coûteux et rapide à entraîner, c\'est un soldat polyvalent tout à fait correct pour les premiers raids et la défense de base.');
define('MANUAL_UDESC_52', 'Le Cavalier éclaireur espionne les villages ennemis à grande vitesse. Il ne peut être repéré que par d\'autres éclaireurs et ne porte aucune arme de combat.');
define('MANUAL_UDESC_53', 'L\'Archer monté décoche des flèches mortelles depuis sa monture. C\'est une unité de raid rapide offrant un bon équilibre entre puissance d\'attaque et capacité de transport.');
define('MANUAL_UDESC_54', 'Le Cavalier des steppes est un escarmoucheur véloce des plaines. Sa rapidité en fait l\'unité idéale pour des raids éclairs sur des villages sans défense.');
define('MANUAL_UDESC_55', 'Le Lancier hun charge avec une lourde lance. Une puissante unité de cavalerie offensive capable également de tenir tête à la cavalerie ennemie.');
define('MANUAL_UDESC_56', 'Le Cavalier d\'élite est la fierté de la horde hunnique. Extrêmement puissant en attaque, il écrase tout sur son passage, mais son entraînement est coûteux.');
define('MANUAL_UDESC_57', 'Le bélier est une lourde machine de guerre destinée à démolir les murailles ennemies. Protégez-le bien, car il est lent et sans défense s\'il est seul.');
define('MANUAL_UDESC_58', 'La catapulte projette des pierres à grande distance pour détruire les bâtiments et les champs ennemis. Elle doit être bien protégée par d\'autres troupes.');
define('MANUAL_UDESC_59', 'Le chef de tribu réduit la loyauté des villages ennemis grâce à sa présence redoutable, jusqu\'à ce qu\'ils rejoignent la horde des Huns.');
define('MANUAL_UDESC_60', 'Les colons sont de courageux sujets qui partent fonder un nouveau village pour les Huns. Il en faut trois, accompagnés de vivres.');
define('MANUAL_UDESC_61', 'L\'esclave armé est peu coûteux et rapide à former. Faible individuellement, il peut submerger les défenses à moindre coût lorsqu\'il est déployé en grand nombre.');
define('MANUAL_UDESC_62', 'Le guerrier égyptien est un solide fantassin au service du pharaon, utile aussi bien pour l\'attaque que pour la défense du royaume.');
define('MANUAL_UDESC_63', 'Le gardien du temple protège les lieux saints d\'Égypte. C\'est une excellente unité défensive contre l\'infanterie ennemie.');
define('MANUAL_UDESC_64', 'L\'éclaireur à cheval chevauche en avant de l\'armée pour espionner les villages ennemis. Seuls les éclaireurs ennemis peuvent l\'arrêter ou le repérer.');
define('MANUAL_UDESC_65', 'Le char parcourt le champ de bataille à toute allure, fauchant l\'infanterie. C\'est une puissante unité de cavalerie défensive de l\'armée égyptienne.');
...
define('MANUAL_UDESC_72', 'Le guerrier de l\'Agogé a été élevé pour la guerre dès l\'enfance. C\'est un défenseur robuste et peu coûteux de la patrie spartiate.');
define('MANUAL_UDESC_73', 'Les Homoioi sont les « égaux », des citoyens spartiates à part entière. Une infanterie lourde dotée d\'une puissance d\'attaque redoutable.');
define('MANUAL_UDESC_74', 'L\'éclaireur Périèque observe les mouvements ennemis pour le compte de Sparte. Seuls les éclaireurs ennemis peuvent le repérer ou l\'arrêter.');
define('MANUAL_UDESC_75', 'Le Cavalier Spartiate patrouille aux frontières de la Laconie. Une unité de cavalerie rapide aux caractéristiques de combat équilibrées.');
define('MANUAL_UDESC_76', 'Les Cavaliers Elpida constituent la garde royale des rois de Sparte. Une cavalerie d\'élite qui excelle en attaque.');
define('MANUAL_UDESC_77', 'Le bélier est une machine de guerre lourde destinée à enfoncer les murailles ennemies. Protégez-le bien, car il est lent et sans défense s\'il est isolé.');
define('MANUAL_UDESC_78', 'La catapulte projette des pierres à grande distance pour détruire les bâtiments et les champs ennemis. Elle doit être bien protégée par d\'autres troupes.');
define('MANUAL_UDESC_79', 'L\'Éphore s\'exprime avec l\'autorité de Sparte, réduisant la loyauté des villages ennemis jusqu\'à ce qu\'ils se soumettent');
define('MANUAL_UDESC_80', 'Les colons sont de courageux sujets qui partent fonder un nouveau village pour Sparte. Il en faut trois, accompagnés de provisions.');
define('MANUAL_UDESC_81', 'Le pillard viking vit pour le pillage. Rapide à former et toujours prêt à prendre la mer pour le prochain raid.');
define('MANUAL_UDESC_82', 'L\'éclaireur viking s\'infiltre discrètement en territoire ennemi pour recueillir des informations. Seuls les éclaireurs ennemis peuvent le repérer.');
define('MANUAL_UDESC_83', 'Le guerrier à la hache manie sa grande hache avec une force brutale. Une puissante unité d\'infanterie offensive du Nord.');
define('MANUAL_UDESC_84', 'Le berserker combat dans une frénésie guerrière, ne craignant ni la douleur ni la mort. Dévastateur en attaque, mais vulnérable en défense.');
define('MANUAL_UDESC_85', 'Le cavalier viking allie la robustesse du Nord à la vitesse d\'un cheval. Une unité de cavalerie polyvalente.');
define('MANUAL_UDESC_86', 'Le huscarl est le garde du corps attitré du Jarl. Une unité d\'élite de cavalerie lourde, redoutée sur toutes les mers.');
define('MANUAL_UDESC_87', 'Le bélier est une lourde machine de guerre destinée à briser les murs ennemis. Protégez-le bien, car il est lent et sans défense s\'il est seul.');
define('MANUAL_UDESC_88', 'La catapulte projette des pierres à grande distance pour détruire les bâtiments et les champs ennemis. Elle doit être bien protégée par d\'autres troupes.');
define('MANUAL_UDESC_89', 'Le Jarl soumet les villages ennemis à sa volonté, réduisant leur loyauté jusqu\'à ce qu\'ils prêtent allégeance au Nord.');
define('MANUAL_UDESC_90', 'Les colons sont de courageux sujets qui partent fonder un nouveau village pour les Vikings. Il en faut trois, accompagnés de provisions.');
define('HEALING_TIME_LEVEL', 'Temps de guérison au niveau');
define('BARRICADE_DESC', 'La barricade protège votre village contre les attaques des autres joueurs. Sa structure en bois multicouche confère un solide bonus de défense.<br>Spécifique à la tribu : Vikings uniquement');

define('BUILDING_MAX_LEVEL_UNDER', 'Bâtiment au niveau maximum atteint');
define('BUILDING_BEING_DEMOLISHED', 'Bâtiment en cours de démolition');
define('COSTS_UPGRADING_LEVEL', 'Coûts </b> pour passer au niveau');
define('WORKERS_ALREADY_WORK', 'Tous les ouvriers sont déjà au travail');
define('CONSTRUCTING_MASTER_BUILDER', 'Construire avec le Maître constucteur');
define('COSTS', 'Coûts');
define('WORKERS_ALREADY_WORK_WAITING', 'Tous les ouvriers sont déjà au travail. (File d\'attente)');
define('ENOUGH_FOOD_EXPAND_CROPLAND', 'Pas assez de nourriture. Développer un champ de céréales.');
define('UPGRADE_WAREHOUSE', 'Développer dépôt');
define('UPGRADE_GRANARY', 'Développer grenier');
define('YOUR_CROP_NEGATIVE', "Votre production de céréales est négative, vous n’obtiendrez jamais les ressources nécessaires.");
define('UPGRADE_LEVEL', 'Monter au niveau ');
define('WAITING', '(file d\'attente)');
define('NEED_WWCONSTRUCTION_PLAN', 'Plan de construction de merveille requis');
define('NEED_MORE_WWCONSTRUCTION_PLAN', 'Plan de construction de la Merveille nécessaire');
...
define('PACKAGES_NOT_REFUND', 'Aucun des forfaits n\'est remboursable');
define('PLUS_FUNC', 'Fonction Plus');
define('REMAINING', 'Restant');
define('MINS', 'min');
define('ACTIVATE', 'Activer');
define('TOO_LITTLE_GOLD', 'Pas assez d\'or');
define('GOLD_ON', 'Activé'); // "attack on" and "gold feature on" can be not the same in different languages
define('PLUS_END', 'Vos avantages PLUS sont terminés');
define('NPC', 'NPC');
define('NO_GOLD', 'Vous ne possédez pas d\'or');
define('GOLD_CLUB', 'Gold Club');
define('NOW', 'maintenant');
define('NPC_TRADE_GOLD', 'Échange NPC');
define('COMPLETE_CONSTRUCTION_R_GOLD', 'Terminer les constructions et les recherches dans ce village maintenant (ne fonctionne pas pour le Palais et la Résidence)');
define('FOR_GAME_SERVER', 'Partie entière');
define('HAVE_NO_INVITED', 'Vous n\'avez pas encore invité de nouveaux joueurs');
define('INVITE_FRIENDS_GOLD', 'Inviter des amis et recevoir de l\'or gratuitement');
define('NEED_MORE_GOLD', 'Il vous faut plus d\'or');
define('ADD_PLUS_FAIL', 'Tentative PLUS échouée');
define('ADD_BONUS_LUMBER_FAIL', 'Tentative de bois échouée');
define('ADD_BONUS_CLAY_FAIL', 'Tentative d\'argile échouée');
define('ADD_BONUS_IRON_FAIL', 'Tentative de fer échouée');
define('ADD_BONUS_CROP_FAIL', 'Tentative de récolte échouée');
define('SELECT_GOLD_OPTION', 'Veuillez sélectionner l\'option que vous souhaitez activer ou prolonger');
define('GET_NOW', 'Obtenir maintenant');
define('BUY_NOW', 'Acheter maintenant');
define('SELECT_REWARD', 'Sélectionner une récompense');
define('VIP_ACCOUNT', 'Compte VIP');
define('USER_NOT_EXISTS', 'Le nom de compte que vous avez saisi n\'existe pas');
define('STATUT_STATUS_UPDATED', 'Votre statut a été mis à jour');

// profile
define('PREFERENCES', 'Préférences');
define('VACATION', 'Vacances');
define('ACTIVATE_VACATION', 'Activer le mode vacances');
...
define('CHANGE_EMAIL', 'Changer l\'adresse e-mail');
define('CHANGE_EMAIL2', 'Veuillez saisir votre ancienne et votre nouvelle adresse e-mail. Vous recevrez ensuite un extrait de code à ces deux adresses, que vous devrez saisir ici');
define('CURRENT_EMAIL', 'E-mail actuel');
define('OLD_EMAIL', 'Ancienne adresse e-mail');
define('NEW_EMAIL', 'Nouvel e-mail');
define('ACCOUNT_SITTERS', 'Co-gestionnaires du compte');
define('ACCOUNT_SITTERS2', 'Un co-gestionnaire peut se connecter à votre compte en utilisant votre nom et son mot de passe. Vous pouvez avoir jusqu\'à deux co-gestionnaires');
define('SITTER_NAME', 'Nom du co-gestionnaire');
define('NO_SITTERS', 'Vous n\'avez aucun co-gestionnaire');
define('RM_SITTER', 'Supprimer le co-gestionnaire');
define('YOU_ARE_SITTER', 'Vous avez été enregistré comme co-gestionnaire sur les comptes suivants. Vous pouvez annuler cela en cliquant sur la croix rouge');
define('DELETE_ACCOUNT', 'Supprimer le compte');
define('DELETE_ACCOUNT2', 'Vous pouvez supprimer votre compte ici. La suppression de votre compte prendra trois jours. Vous pouvez annuler cette opération dans les 24 heures.');
define('YES', 'Oui');
define('NO', 'Non');
define('CONFIRM_W_PASS', 'Confirmer avec le mot de passe');
define('MEDALS', 'Médailles');
define('PLAYER_HAS', 'Ce joueur possède'); // bird 1
define('HOURS_OF_BG_PROT', 'Heures de protection débutant restantes'); // bird 1
define('PLAYER_WAS_REG_ON', 'Ce joueur a enregistré son compte le'); // bird 2
define('NATARS_ACC', 'Compte Natar officiel'); // Natars
define('WW_V_M', 'Village officiel des Merveilles du Monde'); // WW Village
define('ROMAN_T_M', 'Les Romains : Grâce à leur haut niveau de développement social et technologique, les Romains excellent dans la construction et sa coordination. De plus, leurs troupes font partie de l\'élite de Travian. Elles sont très équilibrées et efficaces en attaque comme en défense'); // roman tribe medal
define('TEUTON_T_M', 'Les Teutons : Les Teutons sont la tribu la plus agressive. Leurs troupes sont réputées et craintes pour leur rage et leur frénésie lors des attaques. Ils se déplacent comme une horde de pillards, sans même craindre la mort.'); // teuton tribe medal
define('GAUL_T_M', 'Les Gaulois : Les Gaulois sont la plus pacifique des trois tribus de Travian. Leurs troupes sont entraînées pour une excellente défense, mais leur capacité d\'attaque n\'a rien à envier aux deux autres tribus. Les Gaulois sont des cavaliers nés et leurs chevaux sont célèbres pour leur vitesse. Cela signifie que leurs cavaliers peuvent frapper l\'ennemi exactement là où il peut infliger le plus de dégâts et l\'éliminer rapidement.'); // gaul tribe medal
define('ADMIN_M', 'Administrateur officiel du serveur');
define('MH_M', 'Multihunter officiel du serveur');
define('MH_M2', 'Le Multihunter est une fonction officielle de Travian, principalement utilisée pour faire respecter les règles de Travian au sein d\'un serveur. Tous les Multihunters utilisent le compte nommé Multihunter, dont le seul village est situé en (0|0). Un Multihunter ne peut pas jouer sur le serveur où il occupe ce rôle, mais peut être un joueur actif sur d\'autres serveurs.');
...
define('TASKMASTER_M', 'Compte Maître du jeu');
define('VETERAN_P', 'Joueur vétéran');
define('VETERAN_3_M', 'Médaille obtenue pour 3 ans de jeu sur Travian');
define('VETERAN_5_M', 'Médaille obtenue pour 5 ans de service sur Travian');
define('VETERAN_10_M', 'Médaille obtenue pour 10 ans de service sur Travian');
define('ATT_W_M', 'Meilleurs attaquants de la semaine');
define('DEF_W_M', 'Meilleurs défenseurs de la semaine');
define('POP_W_M', 'Meilleures croissances de population de la semaine');
define('ROB_W_M', 'Meilleurs voleurs de la semaine');
define('CLIMB_W_M', 'Meilleures progressions au classement de la semaine');
define('ATT_DEF_10_W_M', 'Cette médaille récompense les joueurs ayant figuré parmi les 10 meilleurs attaquants et défenseurs de la semaine');
define('ATT_3_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 3 meilleurs attaquants de la semaine');
define('DEF_3_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 3 meilleurs défenseurs de la semaine');
define('POP_3_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 3 meilleurs joueurs ayant progressé en population de la semaine');
define('ROB_3_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 3 meilleurs voleurs de la semaine');
define('CLIMB_3_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 3 meilleurs joueurs ayant progressé dans le classement de la semaine');
define('ATT_10_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 10 meilleurs attaquants de la semaine');
define('DEF_10_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 10 meilleurs défenseurs de la semaine');
define('POP_10_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 10 meilleurs croissances de population de la semaine');
define('ROB_10_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 10 meilleurs voleurs de la semaine');
define('CLIMB_10_W_M', 'Recevoir cette médaille signifie que vous figuriez parmi les 10 meilleurs croissances de classement de la semaine');
define('RECEIVED_IN_W', 'Reçu dans la semaine');
define('POINTS_M', 'Points');
define('RANKS', 'Classements');
define('WEEK', 'Semaine');
define('CATÉGORIE', 'Catégorie');
define('RANK', 'Rang');
define('BB_CODE', 'BB-Code');
define('IN_ROW', 'dans une rangée');
...
define('TZ_LINK_GENERATOR', 'Générateur de liens');
define('TZ_LINK_GENERATOR_DESC', 'Crée un lien basé sur le type de bâtiment plutôt que sur l\'emplacement; il fonctionne donc dans n\'importe quel village, quel que soit l\'endroit où le bâtiment y est construit. Copiez le résultat ci-dessous dans le champ Cible du lien.');
define('TZ_TAB_OPTIONAL', 'Tab (optionel)');
define('TZ_GENERATED_LINK', 'Lien généré');
define('AUTO_COMPL', 'Saisie automatique');
define('AUTO_COMPL2', 'Utilisé pour la place de rassemblement et le marché');
define('OWN_VILLAGES', 'Villages personnels');
define('VILLAGES_NEAR', 'Villages des environs');
define('VILLAGES_ALLI_PLAYERS', 'Villages des joueurs de l\'alliance');
define('REPORT_FILTER', 'Filtre de signalement');
define('NO_REPORTS_TO_OWN', 'Aucun signalement pour les transferts vers ses propres villages');
define('NO_REPORTS_TO_OTH', 'Aucun signalement pour les transferts vers des villages étrangers');
define('NO_REPORTS_FROM_OTH', 'Aucun signalement pour les transferts depuis des villages étrangers');
define('CHANGE_PROFILE', 'Changer de profil');
define('WRITE_MESSAGE', 'Écrire un message');
define('REPORT_PLAYER', 'Signaler un joueur');
define('ARTEFACT1', 'Artéfact');
define('WoW1', 'WW');
...
define('TIME_ZONES_DESC', 'Ici, vous pouvez modifier l\'heure affichée par Travian pour qu\'elle corresponde à votre fuseau horaire');
...
define('ARCHITECTS_SMALL', 'Les petits secrets des architectes');
define('ARCHITECTS_SMALLVILLAGE', 'Ciseau en diamant');
define('ARCHITECTS_LARGE', 'Les grands secrets des architectes');
define('ARCHITECTS_LARGEVILLAGE', 'Marteau en marbre géant');
define('ARCHITECTS_UNIQUE', 'Le secret légendaire des architectes');
define('ARCHITECTS_UNIQUEVILLAGE', "Parchemin d'Hémon");
define('HASTE_DESC', 'Toutes les troupes dans la zone d\'effet se déplacent plus rapidement.');
define('HASTE_SMALL', 'Les bottes légères de Titan');
define('HASTE_SMALLVILLAGE', 'Fer à cheval d\'Opale');
define('HASTE_LARGE', 'Les grandes bottes de Titan');
define('HASTE_LARGEVILLAGE', 'La Charrue d\'Or');
define('HASTE_UNIQUE', 'Les bottes légendaires de Titan');
define('HASTE_UNIQUEVILLAGE', 'Les sandales de Phidippidès');
...
define('EYESIGHT_UNIQUE', 'Les yeux d\'aigle légendaires');
...
define('DIET_SMALL', 'Léger contrôle alimentaire');
define('DIET_SMALLVILLAGE', 'Plateau d\'Argent');
define('DIET_LARGE', 'Excellent contrôle alimentaire');
define('DIET_LARGEVILLAGE', 'Arc de chasse sacré');
define('DIET_UNIQUE', 'Contrôle alimentaire total');
define('DIET_UNIQUEVILLAGE', 'Saint Graal du Roi Arthur');
...
define('ACADEMIC_SMALL', 'Entrainement légèrement amélioré');
define('ACADEMIC_SMALLVILLAGE', 'Ecriture du serment des soldats');
define('ACADEMIC_LARGE', 'Entrainement Supérieur');
define('ACADEMIC_LARGEVILLAGE', 'Déclaration de Guerre');
define('ACADEMIC_UNIQUE', 'Entrainement Ultime');
...
define('STORAGE_SMALL', 'Plan rudimentaire de bâtiments de stockage');
define('STORAGE_SMALLVILLAGE', 'Croquis des constructeurs');
define('STORAGE_LARGE', 'Plan détaillé de bâtiments de stockage');
...
define('CONFUSION_SMALL', 'Légère confusion des rivaux');
define('CONFUSION_SMALLVILLAGE', 'Carte des cavernes oubliées');
define('CONFUSION_LARGE', 'Grande confusion de rivaux');
define('CONFUSION_LARGEVILLAGE', 'Baluchon sans fond');
define('CONFUSION_UNIQUE', 'Confusion totale des rivaux');
...
//Building Plans
define('WILL_SPAWN_IN', 'apparaîtront dans');
define('PLAN', 'Plan de Construction Antique');
define('PLANVILLAGE', 'Plan de la Merveille');
define('PLAN_DESC', 'Avec ce Plan de Construction Antique, vous pourrez construire une Merveille du Monde jusqu\'au niveau 50. Pour construire d\'avantage, votre alliance doit avoir au moins deux plans.');
define('PLAN_INFO', '<h1><b>Plans de construction de la Merveille du Monde</b></h1>
...
define('EDIT_SERV_SETT', 'Editer les paramètres du serveur');
...
define('CONF_SERV_LANG', 'Langage');
define('CONF_SERV_LANG_TOOLTIP', 'Langue utilisée par défaut dans le panneau d\'administration et pour tous les utilisateurs du serveur de jeu par défaut.');
define('CONF_SERV_SERVSPEED', 'Vitesse du Serveur');
define('CONF_SERV_SERVSPEED_TOOLTIP', 'La vitesse du serveur de jeu. Plus la vitesse du serveur de jeu est élevée, plus tous les bâtiments sont construits rapidement, les études et améliorations des forges effectuées, les troupes sont rapidement constituées et la productivité de toutes les ressources augmentée.');
...
define('CONF_SERV_EVASIONSPEED', 'Vitesse d\'évasion');
define('CONF_SERV_EVASIONSPEED_TOOLTIP', 'La vitesse d\'évasion est le temps que les troupes passent sur la route pour rentrer chez elles après une évasion.');
...
define('CONF_SERV_TRAPCAPACITY', 'Capacité du Fabricant de pièges');
define('CONF_SERV_TRAPCAPACITY_TOOLTIP', 'Un multiplicateur pour la capacité du piège des Gaulois, qui permet de capturer des soldats ennemis avant même d\'attaquer le village. La valeur de 1 est égale à la capacité de 400 au niveau de construction 20. Si vous définissez la valeur sur 2, la capacité sera de 800.');
define('CONF_SERV_NATUNITSMULTIPLIER', 'Multiplicateur Unités Natars');
define('CONF_SERV_NATUNITSMULTIPLIER_TOOLTIP', 'Ce paramètre est responsable du nombre de troupes Natars, sur des villages Artefacts et Merveilles.');
define('CONF_SERV_NATARS_SPAWN_TIME', 'Apparition des Natars');
define('CONF_SERV_NATARS_SPAWN_TIME_TOOLTIP', 'Après combien de temps Natars et les artefacts apparaîtront à partir de la date de démarrage du serveur, en jours');
define('CONF_SERV_NATARS_WW_SPAWN_TIME', 'Apparition des Villages Merveilles');
define('CONF_SERV_NATARS_WW_SPAWN_TIME_TOOLTIP', 'Après combien de temps les villages Merveilles apparaîtront à partir de la date de démarrage du serveur, en jours');
define('CONF_SERV_NATARS_WW_BUILDING_PLAN_SPAWN_TIME', 'Apparition des Plans');
define('CONF_SERV_NATARS_WW_BUILDING_PLAN_SPAWN_TIME_TOOLTIP', 'Après combien de temps les plans de construction de Merveille apparaîtront à partir de la date de début du serveur, en jours');
define('CONF_SERV_MAPSIZE', 'Taille de la Carte');
define('CONF_SERV_MAPSIZE_TOOLTIP', 'La taille de la carte du monde du jeu. Ne peut pas être changé sur un serveur de jeu déjà installé.');
define('CONF_SERV_VILLEXPSPEED', 'Vitesse d\'expansion des villages');
define('CONF_SERV_VILLEXPSPEED_TOOLTIP', 'Avec une vitesse lente, plus de points de culture sont nécessaires pour fonder un nouveau village, avec une vitesse rapide, le nombre requis de points de culture est réduit.');
define('CONF_SERV_BEGINPROTECT', 'Protection Débutant');
define('CONF_SERV_BEGINPROTECT_TOOLTIP', 'Protection temporaire qui empêche d\'attaquer les villages de nouveaux joueurs.');
define('CONF_SERV_REGOPEN', 'Enregistrement Ouvert');
define('CONF_SERV_REGOPEN_TOOLTIP', 'Permet d\'activer ou de désactiver l\'inscription des joueurs sur le serveur de jeu.');
define('CONF_SERV_ACTIVMAIL', 'Activation par Mail');
define('CONF_SERV_ACTIVMAIL_TOOLTIP', 'Si activé (Oui), lors de l\'inscription, il sera nécessaire de confirmer l\'adresse e-mail. Si désactivé (Non), aucune confirmation de courrier électronique n\'est requise.');
define('CONF_SERV_QUEST', 'Quêtes');
define('CONF_SERV_QUEST_TOOLTIP', 'Activer (Oui) ou désactiver (Non) les quêtes sur le serveur de jeu.');
define('CONF_SERV_QTYPE', 'Type de Quêtes');
define('CONF_SERV_QTYPE_TOOLTIP', 'Le type de quête peut être officiel, ce qui est un peu plus court, et étendu, ce qui est plus long.');
define('CONF_SERV_DLR', 'Niveau requis pour Démolition');
define('CONF_SERV_DLR_TOOLTIP', 'Le niveau requis du bâtiment principal, pour procéder à la démolition des bâtiments dans le village.');
define('CONF_SERV_WWSTATS', 'Merveille du Monde - Stats');
define('CONF_SERV_WWSTATS_TOOLTIP', 'Activez (Vrai) ou désactivez (Faux) l\'affichage dans les statistiques des villages avec une merveille du monde.');
define('CONF_SERV_NTRTIME', 'Temps de Régénération des Troupes Nature');
define('CONF_SERV_NTRTIME_TOOLTIP', 'Temps à travers lequel les troupes Nature seront restaurées dans des oasis.');
define('CONF_SERV_OASIS_WOOD_PROD_MULT', 'Multiplicateur de prod. de bois dans les oasis');
define('CONF_SERV_OASIS_WOOD_PROD_MULT_TOOLTIP', 'La production de bois de base dans les oasis');
define('CONF_SERV_OASIS_CLAY_PROD_MULT', 'Multiplicateur de prod. d\'argile dans les oasis');
define('CONF_SERV_OASIS_CLAY_PROD_MULT_TOOLTIP', 'La production d\'argile de base dans les oasis');
define('CONF_SERV_OASIS_IRON_PROD_MULT', 'Multiplicateur de prod. de fer dans les oasis');
define('CONF_SERV_OASIS_IRON_PROD_MULT_TOOLTIP', 'La production de fer de base dans les oasis');
define('CONF_SERV_OASIS_CROP_PROD_MULT', 'Multiplicateur de prod. de céréales dans les oasis');
define('CONF_SERV_OASIS_CROP_PROD_MULT_TOOLTIP', 'La production de céréales de base dans les oasis');
define('CONF_SERV_MEDALINTERVAL', 'Intervale des Médailles');
define('CONF_SERV_MEDALINTERVAL_TOOLTIP', 'L\’intervalle de temps pour l\'émission de médailles pour les meilleurs joueurs et alliances. Si ce paramètre est modifié sur le serveur installé, l\'intervalle de temps change après la publication suivante des médailles.');
define('CONF_SERV_TOURNTHRES', 'Limite Place du Tournoi');
define('CONF_SERV_TOURNTHRES_TOOLTIP', 'Le nombre de cases sur la carte, après quoi la place du tournoi commencera à fonctionner.');
define('CONF_SERV_GWORKSHOP', 'Grand Atelier');
define('CONF_SERV_GWORKSHOP_TOOLTIP', 'Activez ou désactivez l\'utilisation d\'un grand atelier.');
define('CONF_SERV_NATARSTAT', 'Afficher Natars dans les statistiques');
define('CONF_SERV_NATARSTAT_TOOLTIP', 'Activez ou désactivez l\'affichage du compte Natars dans les statistiques.');
define('CONF_SERV_PEACESYST', 'Système de Paix');
define('CONF_SERV_PEACESYST_TOOLTIP', 'Activer ou désactiver le système de paix. Lorsque le système de paix sera activé, les joueurs pourront s’attaquer mais, au lieu d’agir dans les rapports, il y aura une inscription de félicitations. Les troupes ne mourront pas de faim.');
define('CONF_SERV_GRAPHICPACK', 'Pack Graphique');
define('CONF_SERV_GRAPHICPACK_TOOLTIP', 'Activez ou désactivez la possibilité d\'utiliser le pack graphique.');
define('CONF_SERV_ERRORREPORT', 'Rapport d\'erreur');
define('CONF_SERV_ERRORREPORT_TOOLTIP', 'Activer ou désactiver l\'affichage des rapports d\'erreur sur le serveur de jeu.');
...
define('CONF_PLUS_PRODUCTDURATION', 'durée de production du bonus +25 %');
...
define('LOG_SETT', 'Paramètres des Logs');
define('EDIT_LOG_SETT', 'Editer les Paramètres des Logs');
define('CONF_LOG_BUILD', 'Log Constuctions');
define('CONF_LOG_BUILD_TOOLTIP', 'Activez ou désactivez l\'affichage des journaux pour la construction de bâtiments dans le village.');
define('CONF_LOG_TECHNOLOGY', 'Log Technologie');
define('CONF_LOG_TECHNOLOGY_TOOLTIP', 'Activez ou désactivez l\'affichage des journaux pour améliorer les troupes dans Forgeron et Armurerie.');
define('CONF_LOG_LOGIN', 'Log des Login');
define('CONF_LOG_LOGIN_TOOLTIP', 'Activer ou désactiver l\’affichage des joueurs qui se connectent au jeu.');
define('CONF_LOG_GOLD', 'Log des Gold');
define('CONF_LOG_GOLD_TOOLTIP', 'Activer ou désactiver l\'affichage des journaux d\'utilisation de Gold par les joueurs.');
define('CONF_LOG_ADMIN', 'Log Admin');
define('CONF_LOG_ADMIN_TOOLTIP', 'Activez ou désactivez l\'affichage des journaux pour les actions de l\'administrateur dans le panneau de configuration.');
define('CONF_LOG_WAR', 'Log des Attaques');
define('CONF_LOG_WAR_TOOLTIP', 'Activer ou désactiver l\'affichage journaux d\'attaque des joueurs.');
define('CONF_LOG_MARKET', 'Log du Marché');
define('CONF_LOG_MARKET_TOOLTIP', 'Activer ou désactiver l\'affichage des journaux du marché par les joueurs.');
define('CONF_LOG_ILLEGAL', 'Log Illégaux');
define('CONF_LOG_ILLEGAL_TOOLTIP', 'Activer (Oui) ou désactiver (Non) l\'affichage des journaux illégaux. (Je ne sais pas exactement ce que c\'est, tentative de faux log ?)');

//Admin setting - Admin/Templates/config.tpl & editNewsboxSet.tpl
define('NEWSBOX_SETT', 'Paramètres Newsbox');
define('EDIT_NEWSBOX_SETT', 'Editer Paramètres des Newsbox');
define('EDIT_NEWSBOX1', 'Newsbox 1');
define('EDIT_NEWSBOX1_TOOLTIP', 'Activer ou désactiver l\'affichage de la Newsbox 1. Affiché sur la page d\'autorisation et sur les pages de jeu.');
define('EDIT_NEWSBOX2', 'Newsbox 2');
define('EDIT_NEWSBOX2_TOOLTIP', 'Activer ou désactiver l\'affichage de la Newsbox 2. Affiché sur la page d\'autorisation et sur les pages de jeu.');
define('EDIT_NEWSBOX3', 'Newsbox 3');
define('EDIT_NEWSBOX3_TOOLTIP', 'Activer ou désactiver l\'affichage de la Newsbox 3. Affiché sur la page d\'autorisation et sur les pages de jeu.');

//Admin setting - Admin/Templates/config.tpl SQL Settings
define('SQL_SETTINGS', 'Paramètres SQL');
define('CONF_SQL_HOSTNAME', 'Hostname');
define('CONF_SQL_HOSTNAME_TOOLTIP', 'Le nom du serveur sur lequel MySQL est démarré (par défaut: localhost).');
define('CONF_SQL_PORT', 'Port');
define('CONF_SQL_PORT_TOOLTIP', 'Port MySQL pour la connexion à distance. Le port standard pour la connexion est: 3306.');
define('CONF_SQL_DBUSER', 'DB Username');
define('CONF_SQL_DBUSER_TOOLTIP', 'Le nom d\'utilisateur pour se connecter à la base de données (par défaut: root).');
...
define('CONF_SQL_DBNAME', 'Nom DB');
define('CONF_SQL_DBNAME_TOOLTIP', 'Nom de la base de données à laquelle vous vous connectez.');
define('CONF_SQL_TBPREFIX', 'Préfixe');
define('CONF_SQL_TBPREFIX_TOOLTIP', 'Le préfixe utilisé pour les tables de la base de données.');
define('CONF_SQL_DBTYPE', 'Type de DB');
define('CONF_SQL_DBTYPE_TOOLTIP', 'Le type de base de données utilisé.');

//Admin setting - Admin/Templates/config.tpl & editExtraSet.tpl
define('EXTRA_SETT', 'Paramètres supplémentaires');
define('EDIT_EXTRA_SETT', 'Editer les Paramètres supplémentaires');
define('CONF_EXTRA_LIMITMAIL', 'Limite de la boîte mail');
define('CONF_EXTRA_LIMITMAIL_TOOLTIP', 'Activez (Oui) ou désactivez (Non) la limite de la boîte mail.');
define('CONF_EXTRA_MAXMAIL', 'Nombre max. de mails');
define('CONF_EXTRA_MAXMAIL_TOOLTIP', 'Le nombre maximal de messages pouvant tenir dans la boîte mail.');

//Admin setting - Admin/Templates/config.tpl & editAdminInfo.tpl
define('ADMIN_INFO', 'Infos Admin');
define('EDIT_ADMIN_INFO', 'Editer infos Admin');
define('CONF_ADMIN_NAME', 'Nom Admin');
define('CONF_ADMIN_NAME_TOOLTIP', 'Nom pour le compte Admin');
define('CONF_ADMIN_EMAIL', 'E-Mail Admin');
define('CONF_ADMIN_EMAIL_TOOLTIP', 'L\'adresse email du compte administrateur.');
define('CONF_ADMIN_SHOWSTATS', 'Inclure l\'Admin dans les Stats');
define('CONF_ADMIN_SHOWSTATS_TOOLTIP', 'Activer (True) ou désactiver (False) l\'affichage du compte administrateur dans les statistiques générales des joueurs.');
define('CONF_ADMIN_SUPPMESS', 'Inclure Messages Support');
define('CONF_ADMIN_SUPPMESS_TOOLTIP', 'Activez (True) ou désactivez (False) l\'envoi de messages à la boîte aux lettres de l\'administrateur adressée au support.');
define('CONF_ADMIN_RAIDATT', 'Permettre les raids et attaques');
define('CONF_ADMIN_RAIDATT_TOOLTIP', 'Activez (True) ou désactivez (False) la possibilité d\'effectuer une attaque et d\'attaquer un administrateur.');
...
define('TZ_OFFER_A_CONFEDERATION', 'proposer un pacte total');
...
define('TZ_ORDERED_PACKAGE', 'Pack commandé');
...
define('TZ_PAYPAL_PACKAGE_A', 'PayPal – Pack A');
define('TZ_PAYPAL_PACKAGE_B', 'PayPal – Pack B');
define('TZ_PAYPAL_PACKAGE_C', 'PayPal – Pack C');
define('TZ_PAYPAL_PACKAGE_D', 'PayPal – Pack D');
define('TZ_PAYPAL_PACKAGE_E', 'PayPal – Pack E');
...
define('TZ_SEND_200_CROP_TO_THE_TASKMASTER', 'Envoyez 200 céréales au maître du jeu.');
...
define('TZ_THE_LARGEST_HUNS', 'Les plus grands Huns');
define('TZ_THE_LARGEST_EGYPTIANS', 'Les plus grands Egyptiens');
define('TZ_THE_LARGEST_SPARTANS', 'Les plus grands Spartiates');
define('TZ_THE_LARGEST_VIKINGS', 'Les plus grands Vikings');
...
define('TZ_THE_MULTIHUNTERS_ARE_RESPONSIBLE_F', 'Les Multihunters sont responsables du respect de');
...
define('TZ_MILESTONE_NOT_YET', 'Pas encore finalisé');
define('TZ_MILESTONE_SECOND_VILLAGE', 'Premier à fonder un 2e village');
define('TZ_MILESTONE_POPULATION_1000', 'Premier à atteindre une population de 1 000');
...
define('TZ_MILESTONE_FIRST_WW_PLAN', 'Premier à conquérir un plan de construction de Merveille');
define('TZ_MILESTONE_FIRST_ALLIANCE', 'Première alliance fondée');
define('TZ_MILESTONE_FIRST_PVP_CONQUEST', 'Premier village conquis à un joueur');
define('TZ_MILESTONE_FIVE_VILLAGES', 'Premier à fonder 5 villages');
define('TZ_MILESTONE_FOUNDED_BY', 'Fondé par');
...
define('MANUAL_DESC_SAWMILL', 'Le bois coupé par vos bûcherons est traité ici. Selon son niveau, votre scierie peut augmenter votre production de bois jusqu\'à 25 %.');
define('MANUAL_DESC_BRICKYARD', 'La briqueterie transforme l\'argile en briques. Selon son niveau, votre briqueterie peut augmenter votre production d\'argile jusqu\'à 25 %.');
define('MANUAL_DESC_IRONFOUNDRY', 'La fonderie de fer fait fondre le fer. Selon son niveau, votre fonderie peut augmenter votre production de fer jusqu\'à 25 %.');
define('MANUAL_DESC_GRAINMILL', 'Le moulin transforme le grain en farine. Selon son niveau, votre moulin peut augmenter votre production de céréales jusqu\'à 25 %.');
define('MANUAL_DESC_BAKERY', 'La boulangerie transforme la farine en pain. Associée au moulin, l\'augmentation de la production de céréales peut atteindre 50 % au total.');
 ...
 * ========================================================================== */
define('HERO_T4_TAB_HERO',       'Héros');
define('HERO_T4_TAB_ITEMS',      'Inventaire');
define('HERO_T4_TAB_ADVENTURES', 'Aventures');
define('HERO_T4_TAB_AUCTION',    'Enchères');
...
define('HERO_SLOT_2', 'Corps');
define('HERO_SLOT_3', 'Main droite');
define('HERO_SLOT_4', 'Main gauche');
define('HERO_SLOT_5', 'Chaussures');
define('HERO_SLOT_6', 'Cheval');
define('HERO_SLOT_7', 'Sac');

/* Inventory actions */
define('HERO_ITEMS_EQUIPPED',    'Équipé');
define('HERO_ITEMS_BAG',         'Inventaire');
define('HERO_ITEMS_EMPTY',       'Votre héros ne possède encore aucun objet. Les aventures et l\'hôtel des enchères sont de bons endroits pour en trouver.');
define('HERO_EQUIP',             'Équiper');
define('HERO_UNEQUIP',           'Retirer');
define('HERO_USE_ITEM',          'Utiliser');
define('HERO_QUANTITY',          'Quantité');
define('HERO_ITEM_USED_OK',      'L\'objet a été utilisé.');
define('HERO_ITEM_USE_FAIL',     'Cet objet ne peut pas être utilisé pour le moment.');
define('HERO_ITEM_USE_BATTLE',   'Cet objet est utilisé automatiquement (les bandages soignent les troupes de retour de bataille).');
define('HERO_EQUIP_OK',          'Objet équipé.');
define('HERO_EQUIP_FAIL',        'Cet objet ne peut pas être équipé (unité de héros ou type d\'objet incompatible).');
define('HERO_UNEQUIP_OK',        'Objet retiré.');

/* Adventures */
define('HERO_ADV_NORMAL',        'une aventure normale');
define('HERO_ADV_HARD',          'une aventure difficile');
define('HERO_ADV_LIST',          'Aventures disponibles');
define('HERO_ADV_NONE',          'Aucune aventure disponible pour le moment. De nouvelles apparaîtront au fil du temps.');
define('HERO_ADV_DIFFICULTY',    'Difficulté');
define('HERO_ADV_DIFF_NORMAL',   'Normal');
define('HERO_ADV_DIFF_HARD',     'Difficile');
define('HERO_ADV_DURATION',      'Durée du trajet (aller simple)');
define('HERO_ADV_EXPIRES',       'Expire dans');
define('HERO_ADV_GO',            'Lancer l\'aventure');
define('HERO_ADV_RUNNING',       'Votre héros est en aventure et arrivera dans');
define('HERO_ADV_START_OK',      'Votre héros est parti à l\'aventure.');
define('HERO_ADV_START_NOHERO',  'Vous avez besoin d\'un héros en vie pour commencer une aventure.');
define('HERO_ADV_START_AWAY',    'Votre héros n\'est pas chez lui.');
define('HERO_ADV_START_FAIL',    'Cette aventure n\'est plus disponible.');
define('HERO_ADV_RETURNED',      'Votre héros est de retour de');
define('HERO_ADV_REWARD',        'Récompense');
define('HERO_ADV_AMOUNT',        'Montant');
define('HERO_ADV_ITEM_FOUND',    'Objet trouvé');
define('HERO_ADV_HP_LOST',       'Points de vie perdus');
define('HERO_ADV_DIED',          'Votre héros a péri lors de');
define('HERO_ADV_DIED_INFO',     'Tout le butin a été perdu. Le héros peut être ressuscité au Manoir du héros.');

/* Auction house */
define('HERO_AUC_OPEN',          'Enchères en cours');
define('HERO_AUC_NONE',          'Aucune enchère en cours pour le moment.');
define('HERO_AUC_ITEM',          'Objet');
define('HERO_AUC_PRICE',         'Prix actuel');
define('HERO_AUC_FINAL_PRICE',   'Prix final');
define('HERO_AUC_TIME_LEFT',     'Fin dans');
define('HERO_AUC_YOUR_MAX',      'Votre maximum');
define('HERO_AUC_BID',           'Enchérir');
define('HERO_AUC_BID_OK',        'Votre enchère a été placée. Vous êtes le meilleur enchérisseur.');
define('HERO_AUC_BID_OUTBID',    'Votre enchère a été immédiatement surenchérie par un maximum plus élevé.');
define('HERO_AUC_BID_FAIL',      'Votre enchère n\'a pas été acceptée.');
define('HERO_AUC_BID_NOSILVER',  'Vous n\'avez pas assez d\'argent pour cette enchère.');
define('HERO_AUC_MY_BIDS',       'Mes enchères');
define('HERO_AUC_MY_SALES',      'Mes ventes');
define('HERO_AUC_SELL',          'Vendre un objet');
define('HERO_AUC_SELL_OK',       'Votre objet a été mis en vente.');
define('HERO_AUC_SELL_FAIL',     'Cet objet ne peut pas être mis en vente (les objets équipés doivent d\'abord être retirés).');
define('HERO_AUC_START_PRICE',   'Prix de départ');
define('HERO_AUC_DURATION',      'Durée');
define('HERO_AUC_LIST',          'Mettre en vente');
define('HERO_AUC_SELLER_NPC',    'Marchand');
define('HERO_AUC_WON',           'Vous avez remporté l\'enchère pour');
define('HERO_AUC_SOLD',          'Votre objet a été vendu :');
define('HERO_AUC_REFUND',        'Remboursement sur votre enchère maximale'); define('HERO_AUC_FEE',           'Frais de vente aux enchères');
define('HERO_AUC_PAYOUT',        'Versement');
define('HERO_AUC_EXPIRED',       'Votre vente aux enchères s\'est terminée sans offre. L\'objet a été renvoyé dans votre inventaire :');

/* Report topics (raw English strings live in ndata.topic) */
define('TZ_RT_ADV_RETURNED',     'Le héros est revenu d\'une aventure');
define('TZ_RT_ADV_FELL',         'Le héros a péri lors d\'une aventure');
define('TZ_RT_AUC_WON',          'Enchère remportée');
define('TZ_RT_AUC_SOLD',         'Objet vendu aux enchères');
define('TZ_RT_AUC_EXPIRED',      'Enchère expirée');

/* T4 hero port - movement display (dorf1 + rally point) */
define('HERO_ADV_MOV_OUT',   'Héros en aventure');
define('HERO_ADV_MOV_BACK',  'Héros de retour d\'aventure');
define('HERO_ADV_MOV_SHORT', 'Aventure');

/* T4 hero port - tooltip effect fragments (heroItemBonusText) */
define('HB_TXT_FIGHT',      'puissance de combat');
define('HB_TXT_UNIT_OFF',   'attaque');
define('HB_TXT_UNIT_DEF',   'défense');
define('HB_TXT_PER',        'par');
define('HB_TXT_VS_NATARS',  'puissance contre les Natars');
define('HB_TXT_RAID',       'ressources pillées');
define('HB_TXT_RETURN',     'vitesse de retour des troupes');
define('HB_TXT_SPEED_OWN',  'vitesse entre ses propres villages');
define('HB_TXT_SPEED_ALLY', 'vitesse entre les villages alliés');
define('HB_TXT_XP',         'expérience');
define('HB_TXT_REGEN',      'PV par jour');
define('HB_TXT_CP',         'points de culture par jour');
define('HB_TXT_TRAIN_CAV',  'temps de formation de la cavalerie');
define('HB_TXT_TRAIN_INF',  'temps de formation de l\'infanterie');
define('HB_TXT_DMG',        'dégâts subis par le héros');
define('HB_TXT_SPEED20',    'vitesse des troupes au-delà de 20 cases');
define('HB_TXT_MOUNT',      'cases/heure à cheval');
define('HB_TXT_HORSE',      'cases/heure (vitesse du héros)');
define('HB_TXT_OINTMENT',   'Soigne 1 % de la santé du héros par unité (max. 99 %)');
define('HB_TXT_SCROLL',     'expérience du héros par parchemin');
define('HB_TXT_BUCKET',     'Ressuscite instantanément le héros sans frais');
define('HB_TXT_TABLET',     '+1 % de loyauté du village par tablette (max. 125 %)');
define('HB_TXT_BOOK',       'Réinitialise les points d\'attribut du héros');
define('HB_TXT_ARTWORK',    'Points de culture équivalant à votre production quotidienne');
define('HB_TXT_BANDAGE_A',  'Soigne');
define('HB_TXT_BANDAGE_B',  'les troupes du héros tombées au combat');
define('HB_TXT_CAGE',       'Capture 1 animal d\'oasis par cage');
define('HB_TXT_NEEDS_HORSE','nécessite un cheval équipé');
define('HB_TXT_ONLY',       'uniquement pour un');
define('HB_TXT_HERO',       'Héros');

/* T4 hero port - captured animals release action */
define('HERO_RELEASE_ANIMALS', 'Relâcher');
define('HERO_RELEASE_CONFIRM', 'Relâcher ces animaux ? Ils partiront pour de bon.');
?>
