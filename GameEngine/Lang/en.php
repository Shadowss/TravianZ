...
tz_def('TZ_PREVIOUS', 'Previous');
tz_def('TZ_NEXT', 'Next');
tz_def('TZ_CLOSE', 'Close');
tz_def('TZ_WORLD', 'World');
tz_def('TZ_ALL_RIGHTS_RESERVED', 'All rights reserved');
tz_def('TZ_LOGIN_SCREEN', 'Log in to the game');
tz_def('TZ_LOGIN_BUTTON', 'Login');
tz_def('TZ_SERVER_STARTS_IN', 'Server will start in:');
tz_def('TZ_START_NOW', 'START NOW');
tz_def('TZ_REGISTRATION_SCREEN', 'Register for the game');
tz_def('TZ_MANUAL', 'Manual');
tz_def('TZ_MAP', 'World Map');
tz_def('TZ_SEND_TROOPS', 'Send Troops');
tz_def('TZ_COMBAT_SIMULATOR', 'Combat simulator');
tz_def('TZ_CROP_FINDER', 'Crop Finder');
...
tz_def('REG_TRIBE_INTRO', 'Great empires begin with important decisions! Are you an attacker who loves competition? Or is your time investment rather low? Are you a team player who enjoys building up a thriving economy to forge the anvil?');
tz_def('TRIBE3_L1', 'Low time requirements');
tz_def('TRIBE3_L2', 'Loot protection and good defense');
tz_def('TRIBE3_L3', 'Excellent, fast cavalry');
tz_def('TRIBE3_L4', 'Well suited to new players');
tz_def('TRIBE1_L1', 'Moderate time requirements');
tz_def('TRIBE1_L2', 'Can develop villages the fastest');
tz_def('TRIBE1_L3', 'Very strong but expensive troops');
tz_def('TRIBE1_L4', 'Hard to play for new players');
tz_def('TRIBE2_L1', 'High time requirements');
tz_def('TRIBE2_L2', 'Good at looting in early game');
tz_def('TRIBE2_L3', 'Strong, cheap infantry');
tz_def('TRIBE2_L4', 'For aggressive players');
tz_def('TRIBE6_L1', 'High time requirements');
tz_def('TRIBE6_L2', 'Impressively strong cavalry');
tz_def('TRIBE6_L3', 'Relies on others for protection');
tz_def('TRIBE6_L4', 'Not recommended for new players');
tz_def('TRIBE7_L1', 'Low time requirements');
tz_def('TRIBE7_L2', 'More resources available');
tz_def('TRIBE7_L3', 'Excellent defensive units');
tz_def('TRIBE7_L4', 'Well suited to new players');
tz_def('TRIBE8_L1', 'Moderate time requirements');
tz_def('TRIBE8_L2', 'Efficient crop consumption');
tz_def('TRIBE8_L3', 'Easier recovery from battles');
tz_def('TRIBE8_L4', 'Recommended for active new players');
tz_def('TRIBE9_L1', 'High time requirements');
tz_def('TRIBE9_L2', 'Fearless raiders, strong offense');
tz_def('TRIBE9_L3', 'Weak defense in the early game');
tz_def('TRIBE9_L4', 'Not recommended for new players');
tz_def('REG_CONFIRM', 'Confirm');
tz_def('REG_BACK', 'Back');
tz_def('REG_POS_INTRO', 'Where do you want to start building up your empire? Use the recommended area for the most ideal location. Or select the area where your friends are located and team up!');
tz_def('REG_RECAP_INTRO', 'Confirm your choices, choose your avatar name, and start your adventure');
tz_def('REG_CHANGE', 'Change');
tz_def('REG_AVATAR', 'Enter your avatar name:');
tz_def('REG_AVATAR_HINT', 'This is your avatar name in the game world.');
tz_def('REG_PLAY', "Let's play");
tz_def('REG_STEP1_TITLE', 'Select your tribe');
tz_def('REG_STEP2_TITLE', 'Select Starting Position');
tz_def('REG_STEP3_TITLE', 'Confirm your selection');
...
tz_def('TZ_PAYMENTS_DISABLED', 'Online payments are disabled on this server.');
