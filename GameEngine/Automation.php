	...
	if(file_exists("GameEngine/Prevention/sendunits.txt")) {
		...
		foreach($dataarray as $data) {
		    ...
		    //MUST TO BE FIX : You need to filter these values
 		    filter_var($battlepart = $battle->calculateBattle($Attacker,$Defender,$def_wall,$att_tribe,$def_tribe,$residence,$attpop,$defpop,$type,$def_ab,$att_ab1,$att_ab2,$att_ab3,$att_ab4,$att_ab5,$att_ab6,$att_ab7,$att_ab8,$tblevel,$stonemason,$walllevel,0,0,0,$AttackerID,$DefenderID,$AttackerWref,$DefenderWref,$conqureby));
