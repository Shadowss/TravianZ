...
<div class="config-card">
  ...
  <table class="config-table">
    ...
    <tr><td><?php echo CONF_SERV_LANG ?> <em class="tooltip">?<span class="classic"><?php echo CONF_SERV_LANG_TOOLTIP ?></span></em></td><td><?php if(LANG == 'en') echo "English"; elseif(LANG == 'fr') echo "French"; elseif(LANG == 'es') echo "Spain"; elseif(LANG == 'rs') echo "Serbian"; elseif(LANG == 'ru') echo "Russian"; elseif(LANG == 'zh_tw') echo "Taiwanese"; ?></td></tr>
