...
?>
<?php
$total_available = (int)($village->awood + $village->aclay  + $village->airon  + $village->acrop);
...
if($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) >= 1 && $total_available >= $total_required) {
