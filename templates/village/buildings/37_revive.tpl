        ...
        <tr>
                <td class="desc">
					...
					<div class="details">
                        ...
                        <img class="r2" src="img/x.gif" alt="{$smarty.const.CLAY}" title="<?php echo CLAY; ?>" /><?php echo $clay; ?>|
                        <img class="r3" src="img/x.gif" alt="{$smarty.const.IRON}" title="<?php echo IRON; ?>" /><?php echo $iron; ?>|
                        <img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="<?php echo CROP; ?>" /><?php echo $crop; ?>|
