...
$troopsTime = $database->getWalkingTroopsTime($village->wid, $newvillage['id'], 0, 0, [300], 0);
...
<h1>Found new village</h1>
	...
	<tbody class="infos">
		<tr>
			<th>Resources</th>
				<td colspan="10">
				<img class="r1" src="img/x.gif" alt="{$smarty.const.LUMBER}" title="Wood" />750 | 
				<img class="r2" src="img/x.gif" alt="{$smarty.const.CLAY}" title="Clay" />750 | 
				<img class="r3" src="img/x.gif" alt="{$smarty.const.IRON}" title="Iron" />750 | 
				<img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="Crop" />750</td>
		</tr>
	</tbody>
</table>
<p class="btn">
