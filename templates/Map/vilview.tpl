...
?>
	<table cellpadding="1" cellspacing="1" id="distribution" class="tableNone">
		...
		<tbody>
						<tr>
				<td class="ico"><img class="r1" src="img/x.gif" alt="<?php echo LUMBER;?>" title="{$smarty.const.LUMBER}" /></td>
				<td class="val"><?php echo $landd['0']; ?></td>
				<td class="desc"><?php echo WOODCUTTER;?></td>

			</tr>
						<tr>
				<td class="ico"><img class="r2" src="img/x.gif" alt="<?php echo CLAY;?>" title="{$smarty.const.CLAY}" /></td>
				<td class="val"><?php echo $landd['1']; ?></td>
				<td class="desc"><?php echo CLAYPIT;?></td>
			</tr>
						<tr>
				<td class="ico"><img class="r3" src="img/x.gif" alt="<?php echo IRON;?>" title="{$smarty.const.IRON}" /></td>

				<td class="val"><?php echo $landd['2']; ?></td>
				<td class="desc"><?php echo IRONMINE;?></td>
			</tr>
						<tr>
				<td class="ico"><img class="r4" src="img/x.gif" alt="<?php echo CROP;?>" title="{$smarty.const.CROP}" /></td>
