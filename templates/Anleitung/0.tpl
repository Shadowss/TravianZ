...
<tr>
	...
	<th>
	    ...
	    <img src="img/un/res/1.gif" width="18" height="12" border="0" alt="{$smarty.const.LUMBER}" />

	</th>

	<th>

	    <img src="img/un/res/2.gif" width="18" height="12" border="0" alt="{$smarty.const.CLAY}" />

	</th>

	<th>

	    <img src="img/un/res/3.gif" width="18" height="12" border="0" alt="{$smarty.const.IRON}" />

	</th>

	<th>

	    <img src="img/un/res/4.gif" width="18" height="12" border="0" alt="{$smarty.const.CROP}" />
