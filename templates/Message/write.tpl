			...
			<div bbArea="message" id="message_container" name="message_container">
				<div id="message_toolbar" name="message_toolbar">
					...
					<div id="message_toolbarWindows">
						<div id="message_resources" name="message_resources"><a href="javascript:void(0);" bbType="o" bbTag="l" ><img src="img/x.gif" class="r1" title="Lumber" alt="{$smarty.const.LUMBER}" /></a><a href="javascript:void(0);" bbType="o" bbTag="cl" ><img src="img/x.gif" class="r2" title="Clay" alt="{$smarty.const.CLAY}" /></a><a href="javascript:void(0);" bbType="o" bbTag="i" ><img src="img/x.gif" class="r3" title="Iron" alt="{$smarty.const.IRON}" /></a><a href="javascript:void(0);" bbType="o" bbTag="c" ><img src="img/x.gif" class="r4" title="Crop" alt="{$smarty.const.CROP}" /></a></div>
