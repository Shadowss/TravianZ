				...
				<div id="text_toolbar" name="text_toolbar">
					...
					<div id="text_toolbarWindows">
						<div id="text_resources" name="text_resources">
								...
								<a href="javascript:void(0);" bbType="o" bbTag="clay" ><img src="img/x.gif" class="r2" title="Clay" alt="{$smarty.const.CLAY}" /></a>
								<a href="javascript:void(0);" bbType="o" bbTag="iron" ><img src="img/x.gif" class="r3" title="Iron" alt="{$smarty.const.IRON}" /></a>
							<a href="javascript:void(0);" bbType="o" bbTag="crop" ><img src="img/x.gif" class="r4" title="Crop" alt="{$smarty.const.CROP}" /></a></div>
