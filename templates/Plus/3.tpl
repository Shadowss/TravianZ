...
?>
		...
		<tr>
			...
			<td class="desc">+<b>25</b>% <img class="r1" src="img/x.gif"
				alt="{$smarty.const.LUMBER}" title="Lumber" /> Production: Lumber<br /> <span
				class="run">
<?php
...
?>
		...
		<tr>
			...
			<td class="desc">+<b>25</b>% <img class="r2" src="img/x.gif"
				alt="{$smarty.const.CLAY}" title="Clay" /> Production: Clay<br /> <span class="run">
<?php
...
?>
		...
		<tr>
			...
			<td class="desc">+<b>25</b>% <img class="r3" src="img/x.gif"
				alt="{$smarty.const.IRON}" title="Iron" /> Production: Iron<br /> <span class="run">
<?php
...
&nbsp;    </span></a></td>
		...
		<tr>
			...
			<td class="desc">+<b>25</b>% <img class="r4" src="img/x.gif"
				alt="{$smarty.const.CROP}" title="Crop" /> Production: Crop<br /> <span class="run">
<?php
