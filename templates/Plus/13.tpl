...
<div align="center">
	<table border="1" width="50%" cellspacing="0" cellpadding="0">
		<tr>
			<td align="center" width="25%"><img class="r1" src="img/x.gif" alt="{$smarty.const.LUMBER}" title="Lumber" />Lumber</td>
			<td align="center" width="25%"><img class="r2" src="img/x.gif" alt="{$smarty.const.CLAY}" title="Clay" />Clay</td>
			<td align="center" width="25%"><img class="r3" src="img/x.gif" alt="{$smarty.const.IRON}" title="Iron" />Iron</td>
			<td align="center" width="25%"><img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="Crop" />Crop</td>
		</tr>
		<tr>
			<td align="center">
<?php
