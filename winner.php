		...
		<div class="wrapper">
			...
			<div id="mid">
				...
				<div id="content" class="village2" style="font-size: 9pt;">
					...
					<br />
					<p>We, the Travian Romania Team, thank you and we look forward to a new adventure in a new Travian world.</p>
					<br />
					Best Regards,<br />
